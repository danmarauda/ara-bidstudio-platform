export const translations = {
  ...
  'auth.request-password-reset.form.email.placeholder': 'Example: ada@alias.app',
  ...
  'auth.login.title': 'Login to ALIAS Docs',
  'auth.login.description': 'Enter your email or use social login to access your ALIAS Docs account.',
  ...
  'auth.login.form.email.placeholder': 'Example: ada@alias.app',
  ...
  'auth.register.title': 'Register to ALIAS Docs',
  'auth.register.description': 'Create an account to start using ALIAS Docs.',
  ...
  'auth.register.registration-disabled.description': 'The creation of new accounts is currently disabled on this instance of ALIAS Docs. Only users with existing accounts can log in. If you think this is a mistake, please contact the administrator of this instance.',
  'auth.register.form.email.label': 'Email',
  'auth.register.form.email.placeholder': 'Example: ada@alias.app',
  ...
  'auth.no-auth-provider.description': 'There are no authentication providers enabled on this instance of ALIAS Docs. Please contact the administrator of this instance to enable them.',
  ...
  'organizations.invite-member.form.email.placeholder': 'Example: ada@alias.app',
  ...
  'api-errors.auth.invalid_origin': 'Invalid application origin. If you are self-hosting ALIAS Docs, ensure your APP_BASE_URL environment variable matches your current url. For more details see https://docs.alias.app/resources/troubleshooting/#invalid-application-origin',
